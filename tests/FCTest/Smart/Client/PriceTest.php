...
class FCTest_Smart_Client_PriceTest extends PHPUnit_Framework_TestCase {

	public function testConstruct() {
		new FC_Smart_Client_Price(123);
		new FC_Smart_Client_Price(-123);
		new FC_Smart_Client_Price(123.45);
		new FC_Smart_Client_Price(-123.45);
	...
	public function testToString() {
		$price = new FC_Smart_Client_Price(123);
		$this->assertSame('123', (string) $price);
		$price = new FC_Smart_Client_Price(-123);
		$this->assertSame('-123', (string) $price);
		$price = new FC_Smart_Client_Price(123.45);
		$this->assertSame('123.45', (string) $price);
		$price = new FC_Smart_Client_Price(-123.45);
		$this->assertSame('-123.45', (string) $price);
		$price = new FC_Smart_Client_Price(123.45, 'USD');
	...
	public function testFromArray() {
		$price = FC_Smart_Client_Price::fromArray(array('value' => 123));
		$this->assertSame(123., $price->getValue());
		$this->assertSame(null, $price->getCurrency());
		$price = FC_Smart_Client_Price::fromArray(array('value' => -123));
		$this->assertSame(-123., $price->getValue());
		$this->assertSame(null, $price->getCurrency());
		$price = FC_Smart_Client_Price::fromArray(array('value' => 123.45));
		$this->assertSame(123.45, $price->getValue());
		$this->assertSame(null, $price->getCurrency());
		$price = FC_Smart_Client_Price::fromArray(array('value' => -123.45));
		$this->assertSame(-123.45, $price->getValue());
		$this->assertSame(null, $price->getCurrency());
		$price = FC_Smart_Client_Price::fromArray(array('value' => 123.45, 'currency' => 'USD'));
		$this->assertSame(123.45, $price->getValue());
		$this->assertSame('USD', $price->getCurrency());
		$price = FC_Smart_Client_Price::fromArray(array('value' => -123.45, 'currency' => 'USD'));
		$this->assertSame(-123.45, $price->getValue());
	...
	public function testFromArray_InvalidParameter_NotAnArray() {
		FC_Smart_Client_Price::fromArray(123);
	}
	...
	public function testFromArray_InvalidParameter_MissingValue() {
		FC_Smart_Client_Price::fromArray(array('currency' => 'USD'));
	}
}
